function autocomplete(inp, arr) {
    ...
    for (var i = 0; i < arr.length; i++) {
      ...
      if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
        ...
        b.addEventListener("click", function(e) {
          ...
          closeAllLists();
          shiftHistory(inp.value);
          if (inp.value == "CSE 170")
            // Change this to YOUR local file path
            window.location.href = "Project/../html/cse170/cse170.html";
        });
        a.appendChild(b);
      }
    }
  ...
  function shiftHistory(newClass) {
    ...
    var histClass = [class1, class2, class3, class4];
    
    for (var j = 3; j > 0; j--)
      histClass[j].textContent = histClass[j - 1].textContent
    
    class1.textContent = newClass;
  }
